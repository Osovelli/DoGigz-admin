...
import UserWorkSamples from "./UserWorkSample"
          ...
          <nav className="space-y-1">
            <button
              className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm transition-colors ${
                activeSideTab === "profile" ? "bg-primary/5 text-primary" : "text-gray-600 hover:bg-emerald-100"
              }`}
            ...
            <button
              className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm transition-colors ${
                activeSideTab === "workSamples" ? "bg-primary/5 text-primary" : "text-gray-600 hover:bg-emerald-100"
              }`}
            ...
            <button
              className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm transition-colors ${
                activeSideTab === "CV" ? "bg-primary/5 text-primary" : "text-gray-600 hover:bg-emerald-100"
              }`}
              onClick={() => setActiveSideTab("CV")}
            >
            ...
            <button
              className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm transition-colors ${
                activeSideTab === "changePassword" ? "bg-primary/5 text-primary" : "text-gray-600 hover:bg-emerald-100"
              }`}
